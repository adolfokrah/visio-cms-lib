...
import useMediaExplorer from '@/lib/hooks/useMediaExplorer';
...
export default function MediaExplorer({
  ...
  const { uploadFiles, files, handleSelectMediaType, selectedFileAltText, setSelectedFileAltText } = useMediaExplorer();
