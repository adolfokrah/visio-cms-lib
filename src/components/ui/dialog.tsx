...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Overlay
    ref={ref}
    className={cn(
      'visio-cms-fixed visio-cms-inset-0 visio-cms-z-50 visio-cms-bg-black/80 visio-cms- data-[state=open]:visio-cms-animate-in data-[state=closed]:visio-cms-animate-out data-[state=closed]:visio-cms-fade-out-0 data-[state=open]:visio-cms-fade-in-0',
      className,
    )}
    {...props}
  />
...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    >
      {children}
      <DialogPrimitive.Close className="visio-cms-dialog-close-btn visio-cms-absolute visio-cms-right-4 visio-cms-top-4 visio-cms-rounded-sm visio-cms-opacity-70 visio-cms-ring-offset-background visio-cms-transition-opacity hover:visio-cms-opacity-100 focus:visio-cms-outline-none focus:visio-cms-ring-2 focus:visio-cms-ring-ring focus:visio-cms-ring-offset-2 disabled:visio-cms-pointer-events-none data-[state=open]:visio-cms-bg-accent data-[state=open]:visio-cms-text-muted-foreground">
