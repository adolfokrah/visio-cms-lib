...
export default function CanvasControls() {
  ...
  return (
    <div className="visio-cms-fixed visio-cms-bottom-3 visio-cms-p-2 visio-cms-flex visio-cms-z-10 visio-cms-gap-3 visio-cms-bg-dark-800 visio-cms-border visio-cms-border-dark-700 visio-cms-rounded-xl visio-cms-w-[235px] visio-cms-left-[calc(50%-100px)]">
      <Button
